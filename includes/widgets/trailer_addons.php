                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                ...
                                '{{WRAPPER}} .trailer-img .popup-youtube svg path,{{WRAPPER}} .trailer-img .popup-movie-link svg path' => 'fill: {{VALUE}};',
                            ],
                        ]
                    );
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .trailer-img .popup-youtube,{{WRAPPER}} .trailer-img .popup-movie-link' => 'font-size: {{SIZE}}{{UNIT}};',
                                '{{WRAPPER}} .trailer-img .popup-youtube svg,{{WRAPPER}} .trailer-img .popup-movie-link svg' => 'width: {{SIZE}}{{UNIT}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                ...
                                '{{WRAPPER}} .trailer-img .popup-youtube:hover svg path,{{WRAPPER}} .trailer-img .popup-movie-link:hover svg path' => 'fill: {{VALUE}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                ...
                                '{{WRAPPER}} .trailer-active .slick-arrow svg path,{{WRAPPER}} .slider-nav-video-item .slick-arrow svg path' => 'fill: {{VALUE}};',
                            ],
                        ]
                    );
                    $this->add_control(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                ...
                                '{{WRAPPER}} .trailer-active .slick-arrow:hover svg path,{{WRAPPER}} .slider-nav-video-item .slick-arrow:hover svg path' => 'fill: {{VALUE}};',
                            ],
                        ]
                    );
                    $this->add_control(
