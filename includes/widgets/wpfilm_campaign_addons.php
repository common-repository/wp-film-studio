                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                ...
                                '{{WRAPPER}} .campaign-active .slick-arrow svg path,{{WRAPPER}} .slider-nav-video-item .slick-arrow svg path' => 'fill: {{VALUE}};',
                            ],
                        ]
                    );
                    $this->add_control(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .campaign-active .slick-arrow,{{WRAPPER}} .slider-nav-video-item .slick-arrow' => 'font-size: {{SIZE}}{{UNIT}};',
                                '{{WRAPPER}} .campaign-active .slick-arrow svg,{{WRAPPER}} .slider-nav-video-item .slick-arrow svg' => 'width: {{SIZE}}{{UNIT}};',
                            ],
                        ]
                    );
                  ...
                  $this->add_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                ...
                                '{{WRAPPER}} .campaign-active .slick-arrow:hover svg path,{{WRAPPER}} .slider-nav-video-item .slick-arrow:hover svg path' => 'fill: {{VALUE}};',
                            ],
                        ]
                    );
                    $this->add_control(
